...
/// Modified from:
/// https://github.com/anegostudios/vsapi/blob/master/Client/UI/Elements/Impl/Interactive/Controls/GuiElementSlider.cs
public class GuiElementSliderCustom : GuiElementControl
{
    ...
    public int alarmValue; // Shows red beyond this point
    ...
    int unscaledHandleWidth = 24;
    int unscaledHandleHeight = 24;
    ...
    public GuiElementSliderCustom(ICoreClientAPI capi, ActionConsumable<int> onNewSliderValue, ElementBounds bounds) : base(capi, bounds)
    {
        unscaledHandleWidth = (int) bounds.fixedHeight + 8;
        unscaledHandleHeight = (int) bounds.fixedHeight + 8;
    ...
    public override void ComposeElements(Context ctxStatic, ImageSurface surfaceStatic)
    {
        ...
        RoundRectangle(ctx, 2, 2, handleWidth, handleWidth, handleWidth/2.0);
    ...
    internal void ComposeFillTexture()
    {
        ...
        ctx.SetSourceRGBA(190.0 / 255.0, 70.0 / 255.0, 0 / 255.0, 1.0);
        ctx.Fill();

        generateTexture(surface, ref fillTexture);
        ctx.Dispose();
        surface.Dispose();
    }
    ...
    public override void RenderInteractiveElements(float deltaTime)
    {
        ...
        api.Render.Render2DTexturePremultipliedAlpha(fillTexture.TextureId, Bounds.renderX + padding, Bounds.renderY + padding, (int)(handlePosition + 5), (int)insetHeight);
    ...
    {
        if (!enabled || args.IsHandled) return;
