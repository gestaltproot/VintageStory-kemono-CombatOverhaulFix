...
public abstract class GuiElementEditableTextBaseCustom : GuiElementTextBase
{
    ...
    override public bool Focusable => true;
    ...
    public GuiElementEditableTextBaseCustom(ICoreClientAPI capi, CairoFont font, ElementBounds bounds) : base(capi, "", font, bounds)
    {
    ...
    /// <summary>
    /// Sets given text, without running TextChanged() callbacks.
    /// </summary>
    /// <param name="text"></param>
    public void SetValueWithoutChange(string text, bool setCaretPosToEnd = true)
    {
        List<string> newLines = Lineize(text);
        lines = new List<string>(newLines);
        linesStaging = new List<string>(lines);
        RecomposeText();
    ...
    public virtual void RecomposeText()
    {
