...
/// Fixes bug in original where scissor is not popped, which causes
/// rendering issues with other elements that use scissor, e.g.
/// when using BeginClip/EndClip for scrollable containers.
public class GuiElementTextInputCustom : GuiElementEditableTextBaseCustom
{
    ...
    public GuiElementTextInputCustom(ICoreClientAPI capi, ElementBounds bounds, Action<string> OnTextChanged, CairoFont font) : base(capi, font, bounds)
    {
    ...
    public override void RenderInteractiveElements(float deltaTime)
    {
        ...
        // Issue: this doesn't restore previous scissor...
        // Easier to just ignore and let text input overflow lol
